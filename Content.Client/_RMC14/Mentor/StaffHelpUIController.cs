...
public sealed class StaffHelpUIController : UIController, IOnSystemChanged<BwoinkSystem>
{
    ...
    private void UpdateClaimIndicator(NetUserId destination)
    {
        ...
        _mentorWindow.ClaimButton.Text = Loc.GetString("rmc-mentor-claim-button-claim");
        ...
        {
            _mentorWindow.ClaimButton.Text = Loc.GetString("rmc-mentor-claim-button-unclaim");
        }
        ...
        _mentorWindow.ClaimIndicator.Text = Loc.GetString("rmc-mentor-claimed-by", ("claims", string.Join(", ", claims)));
    }
}
