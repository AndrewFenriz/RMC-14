...
public sealed class RMCChemicalDispenserBui : BoundUserInterface
{
    ...
    public void Refresh()
    {
        ...
        _window.EnergyLabel.Text = Loc.GetString("rmc-chemical-dispenser-energy", ("energy", energy.Int()));
        ...
        {
            _window.BeakerStatus.Text = Loc.GetString("rmc-chemical-dispenser-no-beaker");
        ...
        else
        {
            ...
            if (_solution.TryGetMixableSolution(contained.Value, out _, out var solution))
            {
                ...
                foreach (var reagent in solution.Contents)
                {
                    ...
                    {
                        Text = Loc.GetString("rmc-chemical-dispenser-reagent-amount", ("amount", reagent.Quantity), ("reagent", reagentName)),
                    });
                }
            }

            _window.BeakerStatus.Text = Loc.GetString("rmc-chemical-dispenser-units", ("units", units), ("maxUnits", maxUnits));
        }
