...
public abstract class SharedRMCTelephoneSystem : EntitySystem
{
    ...
    private void OnTelephoneCallMsg(Entity<RotaryPhoneComponent> ent, ref RMCTelephoneCallBuiMsg args)
    {
        ...
        {
            _popup.PopupEntity(Loc.GetString("rmc-telephone-busy"), user, user, PopupType.MediumCaution);
            return;
        }
        ...
        {
            _popup.PopupEntity(Loc.GetString("rmc-telephone-dial-number", 
                    ("marine", marineMeta.EntityName), 
                    ("phone", phoneMeta.EntityName)), 
                ent);
        }
    ...
    public override void Update(float frameTime)
    {
        ...
        while (pickedUpPhonesQuery.MoveNext(out var uid, out var pickedUp, out var telephone))
        {
            ...
            {
                _popup.PopupEntity(Loc.GetString("rmc-telephone-snap-back", ("phone", uid), ("rotary", rotary)), uid, PopupType.MediumCaution);
            }
