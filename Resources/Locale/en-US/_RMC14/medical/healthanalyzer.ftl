...
rmc-health-analyzer-blood = Blood:
rmc-health-analyzer-none = None

rmc-health-analyzer-unknown-reagents = [color=white][italic]Unknown reagents detected.[/italic][/color]

rmc-health-analyzer-bleeding-status = [bold][color=#DF3E3E] [Bleeding] [/color][/bold]

rmc-health-analyzer-reagent-od = [bold][color=red]{ $reagent } OD[/color][/bold]
...
rmc-health-analyzer-health = Health:
rmc-health-analyzer-damage = Damage:
rmc-health-analyzer-holocard = Holocard:
rmc-health-analyzer-temperature = Body Temperature:
rmc-health-analyzer-pulse = Pulse:
rmc-health-analyzer-chemicals = Chemical Contents
rmc-health-analyzer-advice = Medical Advice

rmc-health-analyzer-fumbling = You start fumbling around with {THE($target)}...
rmc-health-analyzer-cannot-analyze = You can't analyze that!
