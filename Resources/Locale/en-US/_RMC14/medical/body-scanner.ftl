...
rmc-body-scanner-scan-stored = The body scanner console pings as it stores the scan report of {$entity}.
rmc-body-scanner-incompatible = The scanner can't make sense of this creature.
